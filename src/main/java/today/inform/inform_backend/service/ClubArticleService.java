...
public class ClubArticleService {
        ...
        public ClubArticleDetailResponse getClubArticleDetail(Integer articleId) {
                ...
                List<Attachment> attachments = attachmentRepository.findAllByArticleIdAndArticleType(articleId,
                                VendorType.CLUB);
        ...
        public ClubArticleListResponse getClubArticles(Integer page, Integer size, Integer vendorId, String keyword) {
                ...
                java.time.LocalDate dMinus5 = today.plusDays(5);

                Page<ClubArticle> articlePage = clubArticleRepository.findAllWithFilters(vendorId, keyword, today,
                                dMinus5, pageable);
                ...
                Map<Integer, String> firstAttachmentMap = attachmentRepository
                                ...
                                .collect(Collectors.groupingBy(
                                                ...
                                                Collectors.mapping(Attachment::getAttachmentUrl,
                                                                Collectors.collectingAndThen(Collectors.toList(),
                                                                                list -> list.isEmpty() ? null
                                                                                                : list.get(0)))));
