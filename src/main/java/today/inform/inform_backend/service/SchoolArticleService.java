...
public class SchoolArticleService {
    ...
    @Transactional(readOnly = true)
    public SchoolArticleListResponse getSchoolArticles(Integer page, Integer size, List<Integer> categoryIds, List<Integer> vendorIds, String keyword, Integer userId) {
        ...
        Page<SchoolArticle> articlePage = schoolArticleRepository.findAllWithFiltersAndSorting(
                categoryIds, vendorIds, keyword, todayDate, upcomingLimit, endingSoonLimit, pageable
        );
